...
public class FileOutputHelper {
    ...
    static void writeBinStrToFile(String outputStr, String outputFileName) {
    	writeBinStrToFile(outputStr, outputFileName, true);
    }
    
    static void writeBinStrToFile(String outputStr, String outputFileName, boolean append) {
        ...
        try {
            output = new FileOutputStream(outputFileName, append);
